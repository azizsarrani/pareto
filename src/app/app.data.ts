// Import the injectable decorator that allows classes to be provided and injected as a dependency
import { Injectable } from '@angular/core';

// Import the wijmo libraries (used for UI)
import * as wijmo from '@grapecity/wijmo';

// Exports the struct for each data value
...
export class DataService {
    getData() {
        // some raw data
        // Creates an array of the data value struct we created
        let data: TDataItem[] = [
            { make: 'Vokswagen', sales: 253435 },
